 ...
 * application.properties property, and providing access to paths where, say,
 * user-uploaded photos or files can be safely stored.
 * 
 * @author mfreire
 */
public class LocalData {
	...
	/**
	 * Returns a folder-type file with a given name. Beware: you should carefully
	 * escape any user-supplied folderName before trusting it.
	 * 
	 * @param folderName
	...
	/**
	 * Returns a file in a given folder. Beware: you should have carefully escaped
	 * any user-supplied folder or file names prior to calling this.
	 * 
	 * @param folderName
	 * @param fileName
	 * @return a File pointing to baseFolder/folderName/fileName. If the file does
	 *         not exist, it is not created. However, if its folder does not exist,
	 *         it *will* be created (as by a call to getFolder).
	 */
